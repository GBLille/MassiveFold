...
To uninstall MassiveFold, remove the three conda environments (`massivefold-1.7.0`, `mf-afmassive-1.1.8`, `mf-colabfold-1.6.1` and 
...
```bash
conda activate massivefold-1.7.0
```
